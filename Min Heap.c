// Min_Heap code is very trivial once we have max heap tree we just have to invert the inequality
// in the heapify code and rest everything would remain the same
#include <stdio.h>
#include <stdlib.h>
...
//Process of creating heaps from a given arrah
...
int main()
{
  ...
  Insert(a, 78);
   ...
   printf("Min Heap from an array: ");
    DisplayArray(a, n); 

    RootDelete(a, 57);
    printf("array after the deletion of element 57: "); 
    DisplayArray(a, n); 
